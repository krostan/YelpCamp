...
const seedDB = async () => {
  ...
  for (let i = 0; i < 300; i++) {
    ...
    const camp = new Campground({
      ...
      images: [
        {
          url: "https://res.cloudinary.com/dmpihwhhz/image/upload/v1672752869/YelpCamp/1.jpg",
          filename: "YelpCamp/1",
        },
        {
          url: "https://res.cloudinary.com/dmpihwhhz/image/upload/v1672752866/YelpCamp/2.jpg",
          filename: "YelpCamp/2",
        },
      ],
    });
