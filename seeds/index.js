...
const seedDB = async () => {
    ...
    for (let i = 0; i < 300; i++) {
        ...
        const camp = new Campground({
            ...
            description: 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, qui, deserunt unde beatae velit quisquam repudiandae animi aperiam saepe adipisci ratione aut nemo molestias quia illum assumenda consequuntur impedit vel?',
            price: price,
            geometry: {
                type: "Point",
                coordinates: [
